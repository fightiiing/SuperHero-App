    ...
    return (
      ...
      <div className="heroContainer">
        <div className="heroStats">
          ...
          <h3>Fighting Ability = {hero.results[1].powerstats.combat}</h3>
          <h3>Intelligence = {hero.results[1].powerstats.intelligence} <span className="divider">|</span> Strength = {hero.results[1].powerstats.strength} </h3>
...
const thing = () => {
  ...
  <div className="heroContainer">
    <div className="heroStats">
      ...
      <h3>Fighting Ability = {hero.results[3].powerstats.combat}</h3>
      <h3>Intelligence = {hero.results[3].powerstats.intelligence} <span className="divider">|</span> Strength = {hero.results[3].powerstats.strength} </h3>
